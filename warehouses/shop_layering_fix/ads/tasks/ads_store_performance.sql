-- ============================================================
-- 加工作业: ADS 门店绩效评估表
-- 源表: dws_store_sales_daily, dim_store
...
DELETE FROM shop_layering_fix_dm.ads_store_performance
WHERE IF(@full_refresh = 1, 1=1, stat_month = DATE_FORMAT(@etl_date, '%Y-%m'));

-- Step 2: 按月汇总门店KPI，仅处理当月
INSERT INTO shop_layering_fix_dm.ads_store_performance
WITH store_monthly AS (
    ...
    FROM shop_layering_fix_dm.dws_store_sales_daily ssd
...
UPDATE shop_layering_fix_dm.ads_store_performance
