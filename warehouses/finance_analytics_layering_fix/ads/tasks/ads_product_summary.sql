...
TRUNCATE TABLE finance_analytics_layering_fix_dm.ads_product_summary;

INSERT INTO finance_analytics_layering_fix_dm.ads_product_summary
SELECT
...
FROM finance_analytics_layering_fix_dm.dim_product;
