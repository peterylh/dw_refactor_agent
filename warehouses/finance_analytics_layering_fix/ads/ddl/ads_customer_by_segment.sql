DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.ads_customer_by_segment;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.ads_customer_by_segment (
