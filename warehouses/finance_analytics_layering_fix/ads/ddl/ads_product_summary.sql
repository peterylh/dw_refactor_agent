DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.ads_product_summary;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.ads_product_summary (
