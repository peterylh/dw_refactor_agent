...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_risk_assessments;

INSERT INTO finance_analytics_layering_fix_dm.dwd_risk_assessments
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_risk_assessments
),
