...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_economic_indicators;

INSERT INTO finance_analytics_layering_fix_dm.dwd_economic_indicators
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_economic_indicators
),
