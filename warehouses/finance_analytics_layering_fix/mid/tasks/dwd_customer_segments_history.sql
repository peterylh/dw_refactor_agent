...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_customer_segments_history;

INSERT INTO finance_analytics_layering_fix_dm.dwd_customer_segments_history
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_customer_segments_history
),
