...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dim_economic_indicators;

INSERT INTO finance_analytics_layering_fix_dm.dim_economic_indicators
WITH economic_enhanced AS (
    ...
    FROM finance_analytics_layering_fix_dm.dwd_economic_indicators
)
