...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dws_customer_monthly_summary;

INSERT INTO finance_analytics_layering_fix_dm.dws_customer_monthly_summary
WITH monthly_transactions AS (
    ...
    FROM finance_analytics_layering_fix_dm.dwd_transactions
...
monthly_accounts AS (
    ...
    FROM finance_analytics_layering_fix_dm.dwd_accounts
