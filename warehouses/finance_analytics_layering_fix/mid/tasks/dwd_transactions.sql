...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_transactions;

INSERT INTO finance_analytics_layering_fix_dm.dwd_transactions
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_transactions
