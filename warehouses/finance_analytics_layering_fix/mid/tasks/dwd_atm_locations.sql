...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_atm_locations;

INSERT INTO finance_analytics_layering_fix_dm.dwd_atm_locations
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_atm_locations
),
