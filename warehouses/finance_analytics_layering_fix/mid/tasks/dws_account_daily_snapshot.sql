...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dws_account_daily_snapshot;

INSERT INTO finance_analytics_layering_fix_dm.dws_account_daily_snapshot
WITH daily_snapshots AS (
    ...
    FROM finance_analytics_layering_fix_dm.dwd_accounts a
    LEFT JOIN (
        SELECT
            account_id,
