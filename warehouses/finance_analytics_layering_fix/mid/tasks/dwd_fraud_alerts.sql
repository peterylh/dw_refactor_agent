...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_fraud_alerts;

INSERT INTO finance_analytics_layering_fix_dm.dwd_fraud_alerts
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_fraud_alerts
),
