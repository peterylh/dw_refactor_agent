...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_marketing_campaigns;

INSERT INTO finance_analytics_layering_fix_dm.dwd_marketing_campaigns
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_marketing_campaigns
),
