...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_accounts;

INSERT INTO finance_analytics_layering_fix_dm.dwd_accounts
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_accounts
),
