...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dim_customer;

INSERT INTO finance_analytics_layering_fix_dm.dim_customer
WITH customer_current AS (
    SELECT 
        ...
        acquisition_channel,
        tenure_months
    FROM finance_analytics_layering_fix_dm.dwd_customers
),
