...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_merchants;

INSERT INTO finance_analytics_layering_fix_dm.dwd_merchants
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_merchants
),
