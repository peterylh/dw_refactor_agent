...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_customers;

INSERT INTO finance_analytics_layering_fix_dm.dwd_customers
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_customers
),
