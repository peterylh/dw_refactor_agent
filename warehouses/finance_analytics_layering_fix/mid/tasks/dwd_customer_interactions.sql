...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_customer_interactions;

INSERT INTO finance_analytics_layering_fix_dm.dwd_customer_interactions
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_customer_interactions
),
