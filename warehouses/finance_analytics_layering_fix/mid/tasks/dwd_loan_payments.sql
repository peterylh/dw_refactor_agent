...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_loan_payments;

INSERT INTO finance_analytics_layering_fix_dm.dwd_loan_payments
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_loan_payments
),
