...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dim_product;

INSERT INTO finance_analytics_layering_fix_dm.dim_product
WITH product_enhanced AS (
    ...
    FROM finance_analytics_layering_fix_dm.dwd_products
)
