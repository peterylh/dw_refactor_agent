...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_credit_applications;

INSERT INTO finance_analytics_layering_fix_dm.dwd_credit_applications
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_credit_applications
),
