...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_products;

INSERT INTO finance_analytics_layering_fix_dm.dwd_products
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_products
),
