...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dim_location;

INSERT INTO finance_analytics_layering_fix_dm.dim_location
WITH branches AS (
    SELECT
    ...
    FROM finance_analytics_layering_fix_dm.dwd_branch_locations
),
...
atms AS (
    ...
    FROM finance_analytics_layering_fix_dm.dwd_atm_locations
),
