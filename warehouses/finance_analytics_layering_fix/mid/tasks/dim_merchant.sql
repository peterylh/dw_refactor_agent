...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dim_merchant;

INSERT INTO finance_analytics_layering_fix_dm.dim_merchant
WITH merchant_enhanced AS (
    ...
    FROM finance_analytics_layering_fix_dm.dwd_merchants
)
