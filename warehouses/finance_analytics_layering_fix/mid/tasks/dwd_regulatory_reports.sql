...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dwd_regulatory_reports;

INSERT INTO finance_analytics_layering_fix_dm.dwd_regulatory_reports
WITH source AS (
    SELECT * FROM finance_analytics_layering_fix_dm.ods_regulatory_reports
),
