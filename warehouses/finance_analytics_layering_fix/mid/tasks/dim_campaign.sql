...
TRUNCATE TABLE finance_analytics_layering_fix_dm.dim_campaign;

INSERT INTO finance_analytics_layering_fix_dm.dim_campaign
WITH campaign_enhanced AS (
    ...
    FROM finance_analytics_layering_fix_dm.dwd_marketing_campaigns
)
