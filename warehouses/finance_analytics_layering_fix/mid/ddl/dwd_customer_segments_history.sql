DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.dwd_customer_segments_history;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.dwd_customer_segments_history (
