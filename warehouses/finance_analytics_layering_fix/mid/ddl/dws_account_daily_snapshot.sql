DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.dws_account_daily_snapshot;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.dws_account_daily_snapshot (
