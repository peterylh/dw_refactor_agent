DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.dws_customer_monthly_summary;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.dws_customer_monthly_summary (
