DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.dwd_regulatory_reports;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.dwd_regulatory_reports (
