DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.dwd_economic_indicators;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.dwd_economic_indicators (
    date DATETIME NULL,
    year BIGINT NULL,
    quarter BIGINT NULL,
    month BIGINT NULL,
