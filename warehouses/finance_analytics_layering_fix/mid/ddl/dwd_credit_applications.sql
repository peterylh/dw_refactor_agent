DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.dwd_credit_applications;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.dwd_credit_applications (
