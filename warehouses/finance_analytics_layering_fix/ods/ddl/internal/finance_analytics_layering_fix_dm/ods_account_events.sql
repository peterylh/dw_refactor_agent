DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.ods_account_events;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.ods_account_events (
