DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.ods_risk_assessments;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.ods_risk_assessments (
