DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.ods_loan_payments;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.ods_loan_payments (
