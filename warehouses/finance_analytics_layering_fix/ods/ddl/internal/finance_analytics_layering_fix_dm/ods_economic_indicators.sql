DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.ods_economic_indicators;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.ods_economic_indicators (
    date DATETIME NULL,
