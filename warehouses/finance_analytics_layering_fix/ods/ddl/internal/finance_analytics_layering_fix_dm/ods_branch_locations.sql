DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.ods_branch_locations;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.ods_branch_locations (
