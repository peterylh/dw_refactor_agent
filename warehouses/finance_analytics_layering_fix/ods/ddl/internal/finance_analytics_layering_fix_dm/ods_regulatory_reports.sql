DROP TABLE IF EXISTS finance_analytics_layering_fix_dm.ods_regulatory_reports;
CREATE TABLE IF NOT EXISTS finance_analytics_layering_fix_dm.ods_regulatory_reports (
