INSERT INTO finance_analytics_layering_fix_dm.ods_products (product_id, product_name, category, interest_rate, min_balance, monthly_fee, overdraft_limit, product_tier, is_premium, created_at, load_time)
VALUES
