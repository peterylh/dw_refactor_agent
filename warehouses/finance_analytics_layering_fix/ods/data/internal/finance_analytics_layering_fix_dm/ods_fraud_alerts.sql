INSERT INTO finance_analytics_layering_fix_dm.ods_fraud_alerts (alert_id, transaction_id, customer_id, account_id, alert_date, alert_type, alert_severity, investigation_status, resolution_date, amount_recovered, assigned_to, notes, created_at, load_time)
VALUES
