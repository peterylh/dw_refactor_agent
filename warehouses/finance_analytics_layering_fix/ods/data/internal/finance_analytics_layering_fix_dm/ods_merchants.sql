INSERT INTO finance_analytics_layering_fix_dm.ods_merchants (merchant_id, merchant_name, category, mcc_code, city, state, country, latitude, longitude, risk_rating, avg_transaction_amount, is_online, established_date, created_at, load_time)
VALUES
