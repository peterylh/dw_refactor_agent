INSERT INTO finance_analytics_layering_fix_dm.ods_customer_interactions (interaction_id, customer_id, interaction_date, interaction_type, reason, duration_minutes, sentiment_score, satisfaction_rating, resolved, escalated, agent_id, notes, created_at, load_time)
VALUES
