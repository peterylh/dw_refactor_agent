INSERT INTO finance_analytics_layering_fix_dm.ods_account_events (event_id, account_id, customer_id, product_id, event_date, event_type, event_category, old_value, new_value, triggered_by, channel, processed_by, notes, is_reversible, requires_approval, approval_status, load_time)
VALUES
