#!/usr/bin/env python3
"""
生成 warehouses/finance_analytics_layering_fix/ods/data/internal/finance_analytics_layering_fix_dm 下的 ODS 初始化 SQL。
"""
...
DB_NAME = "finance_analytics_layering_fix_dm"
