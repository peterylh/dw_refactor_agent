...
def _rule_classes() -> list[type[AssessRule]]:
    from assess.rules.definitions.asset_completeness import (
        ASSET_COMPLETENESS_RULE_CLASSES,
    )
    from assess.rules.definitions.depth import DepthMiddleLayerIsOptimalRule
    ...
    from assess.rules.definitions.naming import NAMING_RULE_CLASSES
