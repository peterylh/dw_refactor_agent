...
def build_scoped_assessment_plan(
    ...
    dimensions = {
        "reuse": _scoped_dimension(
            scope_name="tables",
            tables=base_tables,
        ),
        "depth": _scoped_dimension(
            scope_name="impacted_ads",
            tables=_impacted_ads_tables(base_tables, context),
        ),
        "model_design": _scoped_dimension(
            scope_name="dependency_closure",
            tables=base_tables,
            edges=_model_design_edges(base_tables, change_analysis, context),
        ),
        ...
        "asset_completeness": _scoped_dimension(
        ...
        "code_quality": _scoped_dimension(
            scope_name="tasks",
            tasks=base_tasks,
        ),
    }
